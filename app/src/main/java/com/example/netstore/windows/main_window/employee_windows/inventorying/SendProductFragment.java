...
import com.example.netstore.databinding.SendProductFragmentBinding;
...
public class SendProductFragment extends Fragment {
    private SendProductFragmentBinding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = SendProductFragmentBinding.inflate(inflater, container, false);
                ...
                viewModel.getInfoData().observe(getViewLifecycleOwner(), new Observer<ObserverObject>() {
                    ...
                    public void onChanged(ObserverObject observerObject) {
                        if (observerObject.tag == "get list place" && observerObject.status) {
                            ...
                            InventoryingPlaceListFragment fragment = new InventoryingPlaceListFragment(placeList, Config.SP_TAG_NAME_SEND_PLACE);

                            getParentFragmentManager()
                                    .beginTransaction()
                                    .replace(R.id.container_fragment, fragment, "inventorying_place")
                                    .addToBackStack("send_product")
                                    .commit();
                        }
                    }
                });
                ...
                viewModel.getInfoData().observe(getViewLifecycleOwner(), new Observer<ObserverObject>() {
                    ...
                    public void onChanged(ObserverObject observerObject) {
                        if (observerObject.tag == "get list product" && observerObject.status) {
                            ...
                            InventoryingProductListFragment fragment = new InventoryingProductListFragment(productList, Config.SP_TAG_NAME_SEND_PRODUCT);
        ...
        binding.saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentPlace != null && currentProduct != null && count >= 0) {
                    ...
                    viewModel.sendInventorying(currentPlace, currentProduct, count);
                }
            }
        });
    }
    ...
    private void setCurrentPositionsItems() {
        ...
        currentPlace = gson.fromJson(preferences.getString(Config.SP_TAG_NAME_SEND_PLACE, ""), Place.class);
        currentProduct = gson.fromJson(preferences.getString(Config.SP_TAG_NAME_SEND_PRODUCT, ""), Product.class);
